...
\subsection{Replicabilidad y acceso abierto}

Con el propósito de garantizar la transparencia y la replicabilidad del estudio, la base analítica consolidada de 628 artículos, los scripts de recolección automatizada (API DOAJ), los módulos de extracción asistida por inteligencia artificial (Gemini 2.5 Flash), el código de simulación Monte Carlo y los generadores de figuras y tablas se encuentran disponibles en un repositorio público de acceso abierto.\footnote{Paquete de replicación: \url{https://github.com/diegomezapy/errores_inferenciales_revistas_sudamerica}} Los archivos PDF de los artículos auditados no se incluyen por razones de derechos de autor, pero pueden descargarse ejecutando los scripts provistos.

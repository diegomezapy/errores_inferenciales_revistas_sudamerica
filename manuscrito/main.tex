...
{\small \textbf{Paquete de replicación:} \href{https://github.com/diegomezapy/errores_inferenciales_revistas_sudamerica}{github.com/diegomezapy/errores\_inferenciales\_revistas\_sudamerica}\par}

\begingroup
\renewcommand{\thefootnote}{\fnsymbol{footnote}}
\footnotetext[1]{%
El repositorio de replicación incluye la base analítica consolidada de 628 artículos, los scripts de recolección (API DOAJ), extracción por inteligencia artificial (Gemini 2.5 Flash), simulación Monte Carlo y generación de figuras. Los archivos PDF de los artículos no se incluyen por razones de derechos de autor, pero pueden descargarse ejecutando los scripts de recolección.%
}
